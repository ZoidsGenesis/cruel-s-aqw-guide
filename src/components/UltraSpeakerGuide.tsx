...
export function UltraSpeakerGuide() {
  const currentTheme = themeColors["ultra-speaker"];
          ...
          >
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <span className="text-yellow-300">HP:</span> <span className="text-white">10,000,000</span>
                </div>
                <div>
                  <span className="text-yellow-300">Location:</span> <span className="text-white">/join ultraspeaker</span>
                </div>
                <div>
          ...
          >
            ...
            <CardContent>
              <p className="text-gray-300">
                Malgor - The First Speaker guide is currently being prepared. Check back soon for complete mechanics, 
